...
const TUTORIAL: readonly Puzzle[] = [
  handmade(
    ...
    '0110',
    1,
    'On when exactly one input is on. Build it from gates — then package it.',
  ),
  handmade(
    'double',
    'Double Trouble',
    '0110111111110110',
    3,
    'Two halves that look awfully similar. Package the first, then place it again.',
  ),
  handmade(
    'parity',
    'Odd One Out',
    '0110100110010110',
    3,
    'On when an odd number of inputs are on. One component, used three times.',
  ),
  handmade(
    'majority',
    'Majority Rules',
    '00010111',
    1,
    'On when at least two of three are on. Components can have three pins too.',
  ),
];
